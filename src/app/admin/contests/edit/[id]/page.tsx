  ...
  const onSubmit = (data: FormValues) => {
    startTransition(async () => {
      try {
        ...
        // Use existing image URL if no new upload and URL is provided
        if (!finalImageUrl && contest?.imageUrl) {
          finalImageUrl = contest.imageUrl;
        }
        ...
        toast({ variant: 'destructive', title: 'Error', description: error.message || 'Failed to update contest.' });
      }
    });
  };
                              ...
                              <Tabs defaultValue="upload" className="w-full">
                                ...
                                <TabsContent value="upload" className="space-y-4">
                                  <ImageUpload 
                                    ...
                                    initialUrl={field.value || contest?.imageUrl || null}
                                  />
                                  {isUploading && (
